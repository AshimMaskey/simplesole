...
const ProductNotFound = () => {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-[#f7f5f2] dark:bg-[#0a0a0a] p-6">
      {/* Icon */}
      <div className="flex justify-center mb-6">
        <Search className="w-20 h-20 text-amber-500 dark:text-amber-400" />
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <Link
          href="/"
          className="px-6 py-3 border-2 border-gray-300 hover:bg-gray-200 rounded-lg font-semibold transition"
        >
          Go Home
        </Link>
      </div>
